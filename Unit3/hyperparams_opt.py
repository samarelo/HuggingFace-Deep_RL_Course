...
# Modified sample_dqn_params to see if I can limit the limit the hyperparameter search space
# With my novice knowledge of RL I couldn't find a way to set these limitations using existing rl_zoo3.train --optimize execution
### potentially can extend rl_zoo3.train to allow providing search space via config file
def sample_MODdqn_params(trial: optuna.Trial, n_actions: int, n_envs: int, additional_args: dict) -> dict[str, Any]:
    """
    Sampler for DQN hyperparams.
    ...
    :return:
    """
    gamma = trial.suggest_categorical("gamma", [0.95, 0.95, 0.98, 0.99])
...
# USE MOD version for dqn
HYPERPARAMS_SAMPLER = {
    "a2c": sample_a2c_params,
    "ars": sample_ars_params,
    "ddpg": sample_ddpg_params,
    "dqn": sample_MODdqn_params,
